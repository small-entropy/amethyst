...
import platform.interfaces.RepositoryInterface;
 ...
 */
public abstract class BaseRepository<S, M, I, F extends Filter, D> 
        implements RepositoryInterface<S, M, I, F, D> 
{
     ...
     * @param model model 
     */
    public BaseRepository(S store, Class<M> model) {
        this.store = store;
