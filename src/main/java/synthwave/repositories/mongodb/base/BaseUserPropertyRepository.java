 ...
 */
public class BaseUserPropertyRepository extends BaseChildUserRepository {
     ...
     */
    public BaseUserPropertyRepository(
            Datastore datastore,
            String field,
     ...
     * @param propertyDTO user property data transfer object
    ...
    public EmbeddedProperty createUserProperty(
        ...
        boolean hasProperty = hasProperty(propertyDTO.getKey(), user);
        if (!hasProperty) {
